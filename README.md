...
* Extra credit:
    ...
    * i think the Mock Location feature for the developer mode is really helpful because you can temporarily set GPS location anywhere for testing purposes. I think this is extrememly helpful for any group projects using Map APIs etc. 
